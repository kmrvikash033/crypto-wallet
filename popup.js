...
document.addEventListener('DOMContentLoaded',function(){
    ...
    .addEventListener("click",copyAdddress);
    document
...
//STATE VARIABLE
let providerURL="https://polygon-amoy.g.alchemy.com/v2/QmidbuxmGSbYY1aNYATLG1-FJenRJ-fk";
...
function handler(){
    ...
    // const private_key = "0dcc9d6d2a36aa7113967bca724eff6b769b0eb3b33a337e8a991c2fcb15e932";

    // const testAccount = "0xD1ACe63141e0514bFe026fE780A230a2c6308DA4";
...
function getSelectedNetwork(e){
    ...
    if(e.target.innerHTML==="Ethereum Mainnet"){
        providerURL  = "https://eth-mainnet.g.alchemy.com/v2/11KSRSqh5xkH85ktxppx2FJacDctWUcb";
        document.getElementById("network").style.display="none";
    }
    else if(e.target.innerHTML==="Polygon Mainnet"){
        providerURL = "https://polygon-mainnet.g.alchemy.com/v2/eJstkWdOdCkV9G-GmIpiltWMA2Ot1qwf";
        document.getElementById("network").style.display="none";
    }
    else if(e.target.innerHTML === "Polygon Mumbai"){
        providerURL = "https://polygon-amoy.g.alchemy.com/v2/QmidbuxmGSbYY1aNYATLG1-FJenRJ-fk";
        document.getElementById("network").style.display="none";
    }
...
function signUp() {
    ...
    // Ensure ethers is loaded and available
    if (typeof ethers !== 'undefined') {
        ...
        if (wallet.address) {
            ...
            // API CALL
            const url = 'http://localhost:3000/api/v1/user/signup'; // Corrected URL

            const data = {
                name: name,
                email: email,
                password: password,
                passwordConfirm: passwordConfirm, // Corrected key to passwordConfirm
            ...
            fetch(url, {
                ...
                document.getElementById("createdMnemonic").innerHTML = wallet.mnemonic.phrase; // Corrected spelling
                ...
                // Avoid reloading the page, to maintain the display changes
...
function myFunction(){
    ...
    fetch(url).then((response)=>response.json()).then((data)=>{
        ...
        <img class="assets_item_img" src = "./assets/theblockchaincoders.png"
        alt="/>
    ...
    fetch("http://localhost:3000/api/v1/account/allaccount").then((response)=>response.json())
    .then((data)=>{
        let accounts = "";
